...
export default function YediYirmiDortAkuServisi() {
    const jsonLd = {
        "@context": "https://schema.org",
        "@type": "LocalBusiness",
        "name": "Akücü Birol - 7/24 Akü Servisi",
        "image": "https://akucubirol.com/logo.png",
        "description": "7/24 akü servisi, gece gündüz hızlı akü değişimi. Nilüfer, Osmangazi, Mudanya'da mobil akü servisi. Hemen ara: 0533 771 76 16.",
        ...
        "url": "https://akucubirol.com/7-24-aku-servisi",
    ...
    return (
        <Layout
            seo={{
                title: "7/24 Akü Servisi – Gece Gündüz Hızlı Akü Değişimi | Akücü Birol",
                description: "7/24 akü servisi ile gece gündüz hızlı akü değişimi. Nilüfer, Osmangazi, Mudanya'da mobil servis. 15 dakikada kapınızda. Hemen ara: 0533 771 76 16.",
                canonical: "/7-24-aku-servisi",
                jsonLd: jsonLd,
            }}
        >
            {/* Hero */}
                ...
                <div className="container-custom">
                    <div className="max-w-4xl mx-auto">
                        <h1 className="font-heading font-bold text-3xl md:text-4xl lg:text-5xl mb-4">
                            7/24 Akü Servisi – Gece Gündüz Hızlı Akü Değişimi
                        </h1>
                        <p className="text-lg md:text-xl text-gray-200 leading-relaxed mb-4">
                            Akünüz gece bitti, sabah işe gidemiyor musunuz? <strong className="text-accent">Akücü Birol</strong>, Nilüfer, Osmangazi ve Mudanya'da <strong>7/24 hizmet</strong> veriyor.
                        </p>
                        <p className="text-base md:text-lg text-gray-300 leading-relaxed mb-6">
                            Gece veya hafta sonu fark etmez — ekibimiz <strong className="text-accent">15 dakika içinde kapınızda!</strong> Üstelik <strong>ücretsiz mobil servis</strong> ve <strong>garantili akü montajı</strong> ile akünüzü hemen yeniliyoruz. Tüm akü markaları mevcut. Bazı modellerde <strong>3 yıl garanti!</strong>
                        </p>
                ...
                <div className="container-custom">
                    <div className="max-w-4xl mx-auto text-center">
                        <p className="text-primary font-semibold text-lg">
                            📞 Hemen ara, 7/24 akü desteği al • ⚡ 15 dakikada kapında • ✅ Ücretsiz yerinde montaj • 🔋 3 yıl garantili aküler
                        </p>
                    </div>
                </div>
            </section>
                        ...
                        <div className="lg:col-span-2 space-y-8">
                            ...
                            <div className="card">
                                <h2 className="font-heading font-semibold text-2xl text-textDark mb-6">
                                    7/24 Akü Servisi ile Gece Gündüz Yanınızdayız
                                </h2>
                                <div className="space-y-4 text-textMuted leading-relaxed">
                                    <p>
                                        <strong className="text-textDark">7/24 akü servisi</strong> ile aracınızın aküsü ne zaman biterse bitsin, yanınızdayız. Gece yarısı, hafta sonu, bayram tatili fark etmez — <strong className="text-textDark">Akücü Birol</strong> olarak Nilüfer, Osmangazi ve Mudanya bölgelerinde <strong>mobil akü servisi</strong> ile hizmet veriyoruz.
                                    </p>
                                    <p>
                                        <strong className="text-textDark">Akü bitti</strong> durumunda hemen arayın, ortalama <strong>15 dakika içinde</strong> adresinize ulaşıyoruz. <strong>Yerinde akü değişimi</strong> ve <strong>ücretsiz akü montajı</strong> ile aracınızı çekiciye yüklemeye gerek yok. Bulunduğunuz yerde akünüzü değiştiriyoruz.
                                    </p>
                                    <p>
                                        Tüm akü markaları stoklarımızda mevcuttur. <strong className="text-textDark">İnci Akü</strong>, <strong>Varta Akü</strong>, <strong>Mutlu Akü</strong>, <strong>Bosch Akü</strong> ve diğer tüm markalar için <strong>oto akü fiyatları</strong> hakkında bilgi alabilirsiniz. Bazı akü modellerinde <strong>3 yıl garanti</strong> sunuyoruz.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="card">
                                <h2 className="font-heading font-semibold text-2xl text-textDark mb-6">
                                    7/24 Akü Servisi Özellikleri
                                </h2>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    {[
                                        { icon: '⚡', title: 'Hızlı Servis', desc: '15 dakikada kapında' },
                                        { icon: '🚗', title: 'Yerinde Montaj', desc: 'Ücretsiz yerinde montaj' },
                                        { icon: '🔍', title: 'Ücretsiz Kontrol', desc: 'Akü kontrolü ücretsiz' },
                                        { icon: '🛡️', title: '3 Yıl Garanti', desc: 'Bazı modellerde 3 yıl garanti' },
                                        { icon: '📞', title: '7/24 Hizmet', desc: 'Gece gündüz kesintisiz' },
                                        { icon: '✅', title: 'Orijinal Ürün', desc: 'Tüm aküler orijinal' },
                                    ].map((feature, index) => (
                            ...
                            <div className="card">
                                <h2 className="font-heading font-semibold text-2xl text-textDark mb-6">
                                    Neden Akücü Birol 7/24 Akü Servisi?
                                </h2>
                                <ul className="space-y-3">
                                    {[
                                        'Yılların tecrübesi ile güvenilir hizmet',
                                        'Ortalama 15 dakikada adresinize ulaşım',
                                        'Ücretsiz yerinde akü montajı',
                                        '3 yıl garantili aküler (bazı modellerde)',
