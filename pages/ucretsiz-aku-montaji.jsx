...
export default function UcretsizAkuMontaji() {
    const jsonLd = {
        "@context": "https://schema.org",
        "@type": "LocalBusiness",
        "name": "Akücü Birol - Ücretsiz Akü Montajı",
        "image": "https://akucubirol.com/logo.png",
        "description": "Ücretsiz akü montajı, Nilüfer, Osmangazi, Mudanya'da yerinde montaj. Akü değişiminde montaj ücreti yok. Hemen ara: 0533 771 76 16.",
        ...
        "url": "https://akucubirol.com/ucretsiz-aku-montaji",
        ...
        "hasOfferCatalog": {
            "@type": "OfferCatalog",
            "name": "Ücretsiz Akü Montajı",
            "itemListElement": [
                {
                    "@type": "Offer",
                    "itemOffered": {
                        "@type": "Service",
                        "name": "Ücretsiz Yerinde Akü Montajı"
                    }
                }
            ]
        }
    ...
    return (
        <Layout
            seo={{
                title: "Ücretsiz Akü Montajı – Nilüfer, Osmangazi, Mudanya | Akücü Birol",
                description: "Akü değişiminde montaj ücreti yok! Ücretsiz akü montajı ile kapınızda hizmet. Nilüfer, Osmangazi, Mudanya'da yerinde montaj. Hemen ara: 0533 771 76 16.",
                canonical: "/ucretsiz-aku-montaji",
                jsonLd: jsonLd,
            }}
        >
            {/* Hero */}
                ...
                <div className="container-custom">
                    <div className="max-w-4xl mx-auto">
                        <h1 className="font-heading font-bold text-3xl md:text-4xl lg:text-5xl mb-4">
                            Ücretsiz Akü Montajı – Nilüfer, Osmangazi, Mudanya
                        </h1>
                        <p className="text-lg md:text-xl text-gray-200 leading-relaxed mb-4">
                            Akü değişiminde montaj ücreti yok!
                        </p>
                        <p className="text-base md:text-lg text-gray-300 leading-relaxed mb-6">
                            Akücü Birol, satın aldığınız aküyü <strong>ücretsiz olarak aracınıza takar</strong>. Uzman ekibimiz <strong>mobil servisle kapınıza gelir</strong>, eski akünüzü alır, yenisini takar. Tüm akülerimiz garantili, bazı modellerde <strong>3 yıla kadar garanti!</strong>
                        </p>
                        <div className="flex flex-col sm:flex-row gap-4 mt-6">
                            ...
                            >
                                ...
                                <span className="hidden sm:inline">Ücretsiz Montajdan Yararlanmak İçin Şimdi Ara — </span>
                ...
                <div className="container-custom">
                    <div className="max-w-4xl mx-auto text-center">
                        <p className="text-primary font-semibold text-lg">
                            ✅ Akü değişiminde montaj ücreti yok • 🚗 Mobil servisle kapınıza geliyoruz • 🔋 3 yıla kadar garanti • ⚡ Uzman ekip ile montaj
                        </p>
                    </div>
                </div>
            </section>
                        ...
                        <div className="lg:col-span-2 space-y-8">
                            ...
                            <div className="card">
                                <h2 className="font-heading font-semibold text-2xl text-textDark mb-6">
                                    Ücretsiz Akü Montajı ile Ekstra Masraf Yok
                                </h2>
                                <div className="space-y-4 text-textMuted leading-relaxed">
                                    <p>
                                        <strong className="text-textDark">Ücretsiz akü montajı</strong> hizmetimiz ile akü değişiminde montaj ücreti ödemiyorsunuz. <strong className="text-textDark">Akücü Birol</strong> olarak satın aldığınız aküyü <strong>ücretsiz olarak aracınıza takıyoruz</strong>. Nilüfer, Osmangazi ve Mudanya bölgelerinde <strong>mobil servis</strong> ile kapınıza geliyoruz.
                                    </p>
                                    <p>
                                        <strong className="text-textDark">Yerinde akü montajı</strong> ile aracınızın bulunduğu yerde akünüzü değiştiriyoruz. Uzman ekibimiz <strong>mobil servisle kapınıza gelir</strong>, eski akünüzü alır, yenisini takar. Tüm işlemler <strong>ücretsiz</strong> ve <strong>profesyonel</strong> şekilde yapılır.
                                    </p>
                                    <p>
                                        Tüm akü markaları stoklarımızda mevcuttur. <strong className="text-textDark">İnci Akü</strong>, <strong>Varta Akü</strong>, <strong>Mutlu Akü</strong>, <strong>Bosch Akü</strong> ve diğer tüm markalar için <strong>oto akü fiyatları</strong> hakkında bilgi alabilirsiniz. Tüm akülerimiz <strong>garantili</strong> ve bazı modellerde <strong>3 yıla kadar garanti</strong> sunuyoruz.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="card">
                                <h2 className="font-heading font-semibold text-2xl text-textDark mb-6">
                                    Ücretsiz Akü Montajı Özellikleri
                                </h2>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    {[
                                        { icon: '✅', title: 'Montaj Ücreti Yok', desc: 'Akü değişiminde montaj ücreti yok' },
                                        { icon: '🚗', title: 'Mobil Servisle Kapınıza', desc: 'Mobil servisle kapınıza geliyoruz' },
                                        { icon: '🔋', title: '3 Yıla Kadar Garanti', desc: 'Bazı modellerde 3 yıla kadar garanti' },
                                        { icon: '⚡', title: 'Uzman Ekip', desc: 'Profesyonel ve deneyimli ekip' },
                            ...
                            <div className="card">
                                <h2 className="font-heading font-semibold text-2xl text-textDark mb-6">
                                    Neden Ücretsiz Akü Montajı Birol?
                                </h2>
                                <ul className="space-y-3">
                                    {[
                                        'Akü değişiminde montaj ücreti yok',
                                        'Mobil servisle kapınıza geliyoruz',
                            ...
                            <div className="card sticky top-24 space-y-6">
                                ...
                                <div className="pt-6 border-t border-gray-200 space-y-3 text-sm text-textMuted">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span>Montaj ücreti yok</span>
                                    </div>
                                    <div className="flex items-center gap-2">
                                        <svg className="w-5 h-5 text-success" fill="currentColor" viewBox="0 0 20 20">
                                            <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                                        </svg>
                                        <span>3 yıla kadar garanti</span>
                                    </div>
                                    <div className="flex items-center gap-2">
                                        <svg className="w-5 h-5 text-success" fill="currentColor" viewBox="0 0 20 20">
                                            <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                                        </svg>
                                        <span>Mobil servisle kapınıza</span>
                                    </div>
                                </div>
                            </div>
                        </div>
