...
export default function GarantiliAkuSatisi() {
    const jsonLd = {
        "@context": "https://schema.org",
        "@type": "LocalBusiness",
        "name": "Akücü Birol - Garantili Akü Satışı",
        "image": "https://akucubirol.com/logo.png",
        "description": "Garantili akü satışı, orijinal ve uzun ömürlü aküler. 3 yıl garantili aküler. Nilüfer, Osmangazi, Mudanya'da hizmet. Hemen ara: 0533 771 76 16.",
        ...
        "url": "https://akucubirol.com/garantili-aku-satisi",
        ...
        "hasOfferCatalog": {
            "@type": "OfferCatalog",
            "name": "Garantili Akü Satışı",
            "itemListElement": [
                {
                    "@type": "Offer",
                    "itemOffered": {
                        "@type": "Service",
                        "name": "3 Yıl Garantili Akü Satışı"
                    }
                }
            ]
        }
    ...
    return (
        <Layout
            seo={{
                title: "Garantili Akü Satışı – Orijinal ve Uzun Ömürlü Aküler | Akücü Birol",
                description: "Akücü Birol'da satılan her akü tam garantilidir. Bazı modeller 3 yıl garanti kapsamındadır. Geniş marka yelpazesi. Hemen ara: 0533 771 76 16.",
                canonical: "/garantili-aku-satisi",
                jsonLd: jsonLd,
            }}
        >
            {/* Hero */}
                ...
                <div className="container-custom">
                    <div className="max-w-4xl mx-auto">
                        <h1 className="font-heading font-bold text-3xl md:text-4xl lg:text-5xl mb-4">
                            Garantili Akü Satışı – Orijinal ve Uzun Ömürlü Aküler
                        </h1>
                        <p className="text-lg md:text-xl text-gray-200 leading-relaxed mb-4">
                            Akücü Birol'da satılan her akü tam garantilidir.
                        </p>
                        <p className="text-base md:text-lg text-gray-300 leading-relaxed mb-6">
                            <strong>Bazı modeller 3 yıl garanti</strong> kapsamındadır. Geniş marka yelpazemizle tüm araçlara uygun aküler sunuyoruz. Üstelik <strong>ücretsiz mobil servis</strong> ve <strong>yerinde montaj</strong> imkanıyla.
                        </p>
                        <div className="flex flex-col sm:flex-row gap-4 mt-6">
                            ...
                            >
                                ...
                                <span className="hidden sm:inline">Hemen Ara, Garantili Akünü Seç — </span>
                ...
                <div className="container-custom">
                    <div className="max-w-4xl mx-auto text-center">
                        <p className="text-primary font-semibold text-lg">
                            🛡️ Her akü tam garantili • 🔋 Bazı modeller 3 yıl garanti • ✅ Orijinal ve uzun ömürlü aküler • 🚗 Ücretsiz mobil servis
                        </p>
                    </div>
                </div>
            </section>
                        ...
                        <div className="lg:col-span-2 space-y-8">
                            ...
                            <div className="card">
                                <h2 className="font-heading font-semibold text-2xl text-textDark mb-6">
                                    Garantili Akü Satışı ile Güvenli Alışveriş
                                </h2>
                                <div className="space-y-4 text-textMuted leading-relaxed">
                                    <p>
                                        <strong className="text-textDark">Garantili akü satışı</strong> ile tüm akülerimiz tam garantilidir. <strong className="text-textDark">Akücü Birol</strong> olarak satılan her akü <strong>orijinal</strong>, <strong>yeni üretim</strong> ve <strong>araç tipinize uygun</strong> olarak seçilir. Bazı akü modellerimiz <strong>3 yıl garanti</strong> kapsamındadır.
                                    </p>
                                    <p>
                                        Geniş marka yelpazemizle tüm araçlara uygun aküler sunuyoruz. <strong className="text-textDark">İnci Akü</strong>, <strong>Varta Akü</strong>, <strong>Mutlu Akü</strong>, <strong>Bosch Akü</strong> ve diğer tüm markalar için <strong>oto akü fiyatları</strong> hakkında bilgi alabilirsiniz. Tüm akülerimiz <strong>garantili</strong> ve <strong>uzun ömürlü</strong> akülerdir.
                                    </p>
                                    <p>
                                        <strong className="text-textDark">Ücretsiz mobil servis</strong> ve <strong>yerinde montaj</strong> imkanıyla Nilüfer, Osmangazi ve Mudanya bölgelerinde hizmet veriyoruz. Montaj ve servis tamamen ücretsizdir.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="card">
                                <h2 className="font-heading font-semibold text-2xl text-textDark mb-6">
                                    Garantili Akü Satışı Özellikleri
                                </h2>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    {[
                                        { icon: '🛡️', title: 'Tam Garanti', desc: 'Her akü tam garantili' },
                                        { icon: '🔋', title: '3 Yıl Garanti', desc: 'Bazı modeller 3 yıl garanti' },
                                        { icon: '✅', title: 'Orijinal Ürün', desc: 'Orijinal ve yeni üretim aküler' },
                                        { icon: '🚗', title: 'Tüm Araçlara Uygun', desc: 'Geniş marka yelpazesi' },
                                        { icon: '📞', title: 'Ücretsiz Mobil Servis', desc: 'Mobil servis tamamen ücretsiz' },
                                        { icon: '⚡', title: 'Yerinde Montaj', desc: 'Yerinde montaj imkanı' },
                                    ].map((feature, index) => (
                            ...
                            <div className="card">
                                <h2 className="font-heading font-semibold text-2xl text-textDark mb-6">
                                    Neden Garantili Akü Satışı Birol?
                                </h2>
                                <ul className="space-y-3">
                                    {[
                                        'Her akü tam garantili',
                                        'Bazı modeller 3 yıl garanti kapsamında',
                                        'Orijinal ve yeni üretim aküler',
                                        'Geniş marka yelpazesi',
                                        'Tüm araçlara uygun aküler',
                                        'Ücretsiz mobil servis',
                                        'Yerinde montaj imkanı',
                            ...
                            <div className="card sticky top-24 space-y-6">
                                ...
                                <div className="pt-6 border-t border-gray-200 space-y-3 text-sm text-textMuted">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span>Her akü tam garantili</span>
                                    </div>
                                    <div className="flex items-center gap-2">
                                        <svg className="w-5 h-5 text-success" fill="currentColor" viewBox="0 0 20 20">
                                            <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                                        </svg>
                                        <span>3 yıl garanti (Bazı modellerde)</span>
                                    </div>
                                    <div className="flex items-center gap-2">
                                        <svg className="w-5 h-5 text-success" fill="currentColor" viewBox="0 0 20 20">
                                            <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
