...
export default function AcilAkuDegisimi() {
    const jsonLd = {
        "@context": "https://schema.org",
        "@type": "LocalBusiness",
        "name": "Akücü Birol - Acil Akü Değişimi",
        "image": "https://akucubirol.com/logo.png",
        "description": "Acil akü değişimi, hızlı mobil servis. Yolda kaldınız mı? Acil akü servisi ile 15 dakikada kapınızda. Hemen ara: 0533 771 76 16.",
        ...
        "url": "https://akucubirol.com/acil-aku-degisimi",
        ...
        "hasOfferCatalog": {
            "@type": "OfferCatalog",
            "name": "Acil Akü Değişimi",
            "itemListElement": [
                {
                    "@type": "Offer",
                    "itemOffered": {
                        "@type": "Service",
                        "name": "Acil Mobil Akü Servisi"
                    }
                }
            ]
        }
    ...
    return (
        <Layout
            seo={{
                title: "Acil Akü Değişimi – Hızlı Mobil Servis | Akücü Birol",
                description: "Yolda kaldın, aracın çalışmıyor mu? Acil akü servisi ile 15 dakikada kapınızda. Nilüfer, Osmangazi, Mudanya'da mobil akü değişimi. Hemen ara: 0533 771 76 16.",
                canonical: "/acil-aku-degisimi",
                jsonLd: jsonLd,
            }}
        >
            {/* Hero */}
                ...
                <div className="container-custom">
                    <div className="max-w-4xl mx-auto">
                        <h1 className="font-heading font-bold text-3xl md:text-4xl lg:text-5xl mb-4">
                            Acil Akü Değişimi – Hızlı Mobil Servis
                        </h1>
                        <p className="text-lg md:text-xl text-gray-200 leading-relaxed mb-4">
                            Yolda kaldın, aracın çalışmıyor mu?
                        </p>
                        <p className="text-base md:text-lg text-gray-300 leading-relaxed mb-6">
                            <strong className="text-accent">Acil Akü Servisi Birol</strong>, bulunduğun yere en yakın ekibini hemen yönlendirir. Nilüfer, Osmangazi ve Mudanya genelinde <strong>mobil akü değişimi hizmeti</strong> veriyoruz. Akü değişimi sadece birkaç dakikada tamamlanır, <strong>üstelik montaj ücreti yok!</strong>
                        </p>
                        <div className="flex flex-col sm:flex-row gap-4 mt-6">
                            ...
                            >
                                ...
                                <span className="hidden sm:inline">Acil Durumlar İçin Hemen Ara — </span>
                ...
                <div className="container-custom">
                    <div className="max-w-4xl mx-auto text-center">
                        <p className="text-primary font-semibold text-lg">
                            🔋 Tüm aküler garantili • 🚗 15 dakika içinde kapında • 📞 Acil durumlar için hemen ara!
                        </p>
                    </div>
                </div>
            </section>
                        ...
                        <div className="lg:col-span-2 space-y-8">
                            ...
                            <div className="card">
                                <h2 className="font-heading font-semibold text-2xl text-textDark mb-6">
                                    Acil Akü Değişimi ile Hızlı Çözüm
                                </h2>
                                <div className="space-y-4 text-textMuted leading-relaxed">
                                    <p>
                                        <strong className="text-textDark">Acil akü değişimi</strong> hizmetimiz ile yolda kaldığınızda, aracınız çalışmadığında hemen yanınızdayız. <strong className="text-textDark">Acil akü servisi</strong> ile Nilüfer, Osmangazi ve Mudanya bölgelerinde <strong>mobil akü değişimi</strong> yapıyoruz.
                                    </p>
                                    <p>
                            ...
                            <div className="card">
                                <h2 className="font-heading font-semibold text-2xl text-textDark mb-6">
                                    Acil Akü Değişimi Özellikleri
                                </h2>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    {[
                                        { icon: '🔋', title: 'Tüm Aküler Garantili', desc: 'Tüm akülerimiz garantili' },
                                        { icon: '🚗', title: '15 Dakikada Kapında', desc: 'Ortalama 15 dakikada adresinize ulaşıyoruz' },
                                        { icon: '📞', title: 'Acil Durumlar İçin', desc: 'Acil durumlar için hemen ara' },
                                        { icon: '✅', title: 'Ücretsiz Montaj', desc: 'Montaj ücreti yok' },
                                        { icon: '⚡', title: 'Hızlı Servis', desc: 'Birkaç dakikada tamamlanır' },
                            ...
                            <div className="card sticky top-24 space-y-6">
                                ...
                                <div className="pt-6 border-t border-gray-200 space-y-3 text-sm text-textMuted">
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span>Tüm aküler garantili</span>
                                    </div>
                                    <div className="flex items-center gap-2">
                                        <svg className="w-5 h-5 text-success" fill="currentColor" viewBox="0 0 20 20">
                                            <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                                        </svg>
                                        <span>Acil durumlarda hızlı müdahale</span>
                                    </div>
                                </div>
                            </div>
                        </div>
