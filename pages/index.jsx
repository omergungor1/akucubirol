...
export default function Home() {
  ...
  const features = [
    ...
    },
    {
      ...
      title: '3 Yıl Garanti',
      description: 'Tüm akülerimiz 3 yıl garantili. Orijinal ürün güvencesiyle hizmet.',
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      title: 'Hızlı Servis',
      description: 'Aradığınız anda harekete geçiyoruz. Ortalama 30 dakikada yanınızdayız.',
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
