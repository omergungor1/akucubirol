...
export default function FiyatAl() {
    const jsonLd = {
        "@context": "https://schema.org",
        "@type": "LocalBusiness",
        "name": "Akücü Birol - Akü Fiyatı Öğren",
        "image": "https://akucubirol.com/logo.png",
        "description": "Aracına en uygun akü fiyatını öğrenmek çok kolay! WhatsApp'tan konum gönder, araç modelini yaz, en uygun fiyatı hemen iletelim. Hemen ara: 0533 771 76 16.",
        ...
        "url": "https://akucubirol.com/fiyat-al",
    ...
    return (
        <Layout
            seo={{
                title: "Akü Fiyatı Öğren – Hemen Teklif Al | Akücü Birol",
                description: "Aracına en uygun akü fiyatını öğrenmek çok kolay! WhatsApp'tan konum gönder, araç modelini yaz, en uygun fiyatı hemen iletelim. Tüm fiyatlara montaj ve servis dahil. Hemen ara: 0533 771 76 16.",
                canonical: "/fiyat-al",
                jsonLd: jsonLd,
            }}
        >
                ...
                <div className="container-custom">
                    <div className="max-w-4xl mx-auto">
                        <h1 className="font-heading font-bold text-3xl md:text-4xl lg:text-5xl mb-4">
                            Akü Fiyatı Öğren – Hemen Teklif Al
                        </h1>
                        <p className="text-lg md:text-xl text-gray-200 leading-relaxed mb-4">
                            Aracına en uygun akü fiyatını öğrenmek çok kolay!
                        </p>
                        <p className="text-base md:text-lg text-gray-300 leading-relaxed mb-6">
                            <strong>WhatsApp'tan konum gönder</strong>, araç modelini yaz, en uygun fiyatı hemen iletelim. Tüm fiyatlara <strong>montaj ve servis dahil</strong>. <strong>Nilüfer, Osmangazi ve Mudanya</strong> bölgelerinde hızlı teslimat.
                        </p>
                        <div className="flex flex-col sm:flex-row gap-4 mt-6">
                            ...
                            >
                                ...
                                <span className="hidden sm:inline">Hemen Ara veya WhatsApp'tan Fiyat Al — </span>
                ...
                <div className="container-custom">
                    <div className="max-w-4xl mx-auto text-center">
                        <p className="text-primary font-semibold text-lg">
                            💬 WhatsApp'tan konum gönder, araç modelini yaz • 💰 En uygun fiyatı hemen iletelim • ✅ Tüm fiyatlara montaj ve servis dahil • 🚗 Hızlı teslimat
                        </p>
                    </div>
                </div>
            </section>
                        ...
                        <div className="lg:col-span-2 space-y-8">
                            ...
                            <div className="card">
                                <h2 className="font-heading font-semibold text-2xl text-textDark mb-6">
                                    Akü Fiyatı Öğrenmek Çok Kolay
                                </h2>
                                <div className="space-y-4 text-textMuted leading-relaxed">
                                    <p>
                                        <strong className="text-textDark">Akü fiyatı öğrenmek</strong> için hemen arayın veya <strong>WhatsApp'tan konum gönderin</strong>. Araç modelinizi yazın, <strong>en uygun fiyatı</strong> hemen iletelim. <strong className="text-textDark">Akücü Birol</strong> olarak tüm akü markaları için <strong>oto akü fiyatları</strong> hakkında bilgi veriyoruz.
                                    </p>
                                    <p>
                                        Tüm fiyatlara <strong>montaj ve servis dahil</strong>. <strong className="text-textDark">Ücretsiz mobil servis</strong> ve <strong>yerinde akü montajı</strong> ile Nilüfer, Osmangazi ve Mudanya bölgelerinde hizmet veriyoruz. <strong>60 amper oto akü fiyatları</strong>, <strong>72 amper oto akü fiyatları</strong> ve diğer amper değerleri için fiyat teklifi alabilirsiniz.
                                    </p>
                                    <p>
                                        Tüm akülerimiz <strong>garantili</strong> ve bazı modellerde <strong>3 yıl garanti</strong> sunuyoruz. <strong className="text-textDark">İnci Akü</strong>, <strong>Varta Akü</strong>, <strong>Mutlu Akü</strong>, <strong>Bosch Akü</strong> ve diğer tüm markalar için fiyat teklifi alabilirsiniz.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="card">
                                <h2 className="font-heading font-semibold text-2xl text-textDark mb-6">
                                    Fiyat Teklifi Özellikleri
                                </h2>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    {[
                                        { icon: '💬', title: 'WhatsApp ile Hızlı', desc: 'WhatsApp\'tan konum gönder, fiyat al' },
                                        { icon: '💰', title: 'En Uygun Fiyat', desc: 'En uygun fiyatı hemen iletelim' },
                                        { icon: '✅', title: 'Montaj ve Servis Dahil', desc: 'Tüm fiyatlara montaj ve servis dahil' },
                                        { icon: '🚗', title: 'Hızlı Teslimat', desc: 'Nilüfer, Osmangazi, Mudanya\'da hızlı teslimat' },
                                        { icon: '📞', title: 'Hemen Ara', desc: 'Telefon ile hemen fiyat al' },
                                        { icon: '🛡️', title: 'Garantili Aküler', desc: 'Tüm aküler garantili' },
                                    ].map((feature, index) => (
                            ...
                            <div className="card">
                                <h2 className="font-heading font-semibold text-2xl text-textDark mb-6">
                                    Neden Fiyat Teklifi Birol?
                                </h2>
                                <ul className="space-y-3">
                                    {[
                                        'WhatsApp ile hızlı fiyat teklifi',
                                        'En uygun fiyat garantisi',
                                        'Tüm fiyatlara montaj ve servis dahil',
                                        'Hızlı teslimat',
                                        'Tüm akü markaları için fiyat teklifi',
                                        'Garantili aküler',
                                        'Profesyonel ve deneyimli ekip',
                                        'Nilüfer, Osmangazi, Mudanya\'da hizmet',
                                    ].map((item, index) => (
                            ...
                            <div className="card sticky top-24 space-y-6">
                                ...
                                <div className="pt-6 border-t border-gray-200 space-y-3 text-sm text-textMuted">
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span>Montaj ve servis dahil</span>
                                    </div>
                                    <div className="flex items-center gap-2">
                                        <svg className="w-5 h-5 text-success" fill="currentColor" viewBox="0 0 20 20">
                                            <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
