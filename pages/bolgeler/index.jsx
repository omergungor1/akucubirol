...
export default function Bolgeler() {
  const regions = [
    ...
    },
    {
      name: 'Yıldırım',
      slug: 'yildirim',
      description: 'Yıldırım ilçesine garantili akü satış ve profesyonel montaj hizmeti.',
      neighborhoods: 15,
      popular: ['Millet', 'Esenevler', 'Yıldırım', 'Yenişehir', 'İhsaniye'],
    },
    {
      name: 'Mudanya',
      slug: 'mudanya',
    ...
    },
    {
      name: 'Gemlik',
      slug: 'gemlik',
      description: 'Gemlik bölgesine hızlı ve güvenilir akü servisi. 3 yıl garantili aküler.',
      neighborhoods: 6,
      popular: ['Cumhuriyet', 'Kayhan', 'Adliye', 'Yeni Mahalle', 'Merkez'],
    },
    {
      name: 'Gürsu',
      slug: 'gursu',
      description: 'Gürsu ilçesine anında yerinde akü değişimi ve montaj hizmeti.',
      neighborhoods: 5,
      popular: ['Atatürk', 'Kurtuluş', 'Fevzipaşa', 'Yuksel', 'Merkez'],
    },
  ];
  ...
  return (
    <Layout
      seo={{
        ...
        description: "Nilüfer, Osmangazi, Mudanya, Yıldırım, Gemlik ve Gürsu'da 7/24 mobil akü servisi. Ücretsiz yerinde montaj. Hemen arayın: +90 533 771 76 16.",
        canonical: "/bolgeler",
      }}
    >
      {/* Hero */}
        ...
        <div className="container-custom">
          <div className="max-w-4xl mx-auto text-center">
            <p className="text-primary font-semibold text-lg">
              🚗 Ortalama 30 dakikada adresinize ulaşıyoruz • Ücretsiz yerinde montaj • 3 yıl garanti
            </p>
          </div>
        </div>
      </section>
              ...
              {[
                {
                  ...
                  title: 'Hızlı Ulaşım',
                  description: 'Ortalama 30 dakikada adresinize ulaşıyoruz',
                },
                {
                  icon: <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" /></svg>,
                  title: '3 Yıl Garanti',
                  description: 'Tüm akülerimizde tam garanti kapsamı',
                },
                {
