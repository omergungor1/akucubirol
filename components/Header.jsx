  ...
  return (
    <>
          ...
          <div className="flex items-center justify-between h-16 lg:h-20">
            ...
            <Link href="/" className="flex items-center space-x-2 group">
              <div className="flex items-center">
                <svg 
                  className="w-8 h-8 lg:w-10 lg:h-10 text-accent group-hover:scale-110 transition-transform" 
                  fill="currentColor" 
                  viewBox="0 0 24 24"
                  aria-hidden="true"
                >
      ...
      >
        ...
        {/* Menu Panel */}
        <nav
          className={`absolute top-16 right-0 bottom-0 w-64 bg-primary shadow-2xl transform transition-transform duration-300 ${
